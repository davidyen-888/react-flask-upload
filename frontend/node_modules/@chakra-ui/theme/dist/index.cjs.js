...
function getBg(props) {
  ...
  const lightBg = (0, import_theme_tools.getColor)(theme2, `${c}.100`, c);
  const darkBg = (0, import_theme_tools.transparentize)(`${c}.200`, 0.16)(theme2);
  return (0, import_theme_tools.mode)(lightBg, darkBg)(props);
}
var variantSubtle = definePartsStyle2((props) => {
  const { colorScheme: c } = props;
  const fg = (0, import_theme_tools.mode)(`${c}.500`, `${c}.200`)(props);
  return {
    container: {
...
var variantSolid = definePartsStyle2((props) => {
  const { colorScheme: c } = props;
  const bg = (0, import_theme_tools.mode)(`${c}.500`, `${c}.200`)(props);
  const fg = (0, import_theme_tools.mode)(`white`, `gray.900`)(props);
  return {
    container: {
...
var baseStyleBadge = (0, import_styled_system3.defineStyle)((props) => {
  return {
    borderRadius: "full",
    border: "0.2em solid",
    borderColor: (0, import_theme_tools2.mode)("white", "gray.800")(props)
  };
});
var baseStyleExcessLabel = (0, import_styled_system3.defineStyle)((props) => {
  return {
    bg: (0, import_theme_tools2.mode)("gray.200", "whiteAlpha.400")(props)
  };
});
var $avatarBg = (0, import_theme_tools2.cssVar)("avatar-background");
var baseStyleContainer2 = (0, import_styled_system3.defineStyle)((props) => {
  ...
  if (!isBgDark)
    color = "gray.800";
  const borderColor = (0, import_theme_tools2.mode)("white", "gray.800")(props);
  return {
...
var variantSolid2 = (0, import_styled_system4.defineStyle)((props) => {
  ...
  return {
    bg: (0, import_theme_tools3.mode)(`${c}.500`, dark)(props),
    color: (0, import_theme_tools3.mode)(`white`, `whiteAlpha.800`)(props)
  };
});
var variantSubtle2 = (0, import_styled_system4.defineStyle)((props) => {
  ...
  return {
    bg: (0, import_theme_tools3.mode)(`${c}.100`, darkBg)(props),
    color: (0, import_theme_tools3.mode)(`${c}.800`, `${c}.200`)(props)
  };
});
var variantOutline = (0, import_styled_system4.defineStyle)((props) => {
  ...
  const lightColor = (0, import_theme_tools3.getColor)(theme2, `${c}.500`);
  const color = (0, import_theme_tools3.mode)(lightColor, darkColor)(props);
  return {
    color,
...
var $bg2 = (0, import_theme_tools25.cssVar)("tooltip-bg");
var $fg2 = (0, import_theme_tools25.cssVar)("tooltip-fg");
